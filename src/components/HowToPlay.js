...
import './howto.css'
 ...
 class HowToPlay extends Component {
  ...
  return(
    ...
    <ol> If more than one person finishes all 5 phases at the same time, then the person with the least amount of points WINS! YAY! </ol>
    ...
    <ol> Skip and Wild cards are worth 25 points! </ol>
    </div>
);
}
}
